const firebaseConfig = {
  ...
  function submitForm(e) {
    ...
    var emergencycontacts = getElementVal("emergencycontacts");
  
  
  
    saveMessages(username, password, emailid, aadhar,emergencycontacts);
  ...
  const saveMessages = (username, password, emailid, aadhar,emergencycontacts) => {
